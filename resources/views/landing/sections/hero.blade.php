    ...
    <div class="flex flex-col items-center gap-2 lg:min-h-0 lg:justify-between">
        <div class="flex min-h-0 w-full flex-col gap-3 sm:mt-4 sm:gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-8">
            ...
            <div class="flex shrink-0 flex-col items-center gap-2 text-center lg:items-end lg:text-right">
                ...
                <a href="{{ route('booking.index') }}" class="my-2 inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-2.5 font-dosis text-base font-semibold shadow-md transition-colors hover:bg-brand-strong sm:mt-6 sm:px-7 sm:py-3 sm:text-lg">
